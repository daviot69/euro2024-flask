...
session.add(Country(country_name="Spain", wildcard_group_id=None))
session.add(Country(country_name="France", wildcard_group_id=None))
session.add(Country(country_name="Portugal", wildcard_group_id=None))
session.add(Country(country_name="Wales", wildcard_group_id=None))
session.add(Country(country_name="Scotland", wildcard_group_id=None))
session.add(Country(country_name="England", wildcard_group_id=None))
session.add(Country(country_name="Denmark", wildcard_group_id=None))
session.add(Country(country_name="Holland", wildcard_group_id=None))
session.add(Country(country_name="Belgium", wildcard_group_id=None))
session.add(Country(country_name="Turkey", wildcard_group_id=None))
session.add(Country(country_name="Ukraine", wildcard_group_id=None))
session.add(Country(country_name="Italy", wildcard_group_id=None))
session.add(Country(country_name="Croatia", wildcard_group_id=None))
session.add(Country(country_name="Romania", wildcard_group_id=None))
